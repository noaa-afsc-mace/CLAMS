# Form implementation generated from reading ui file 'NumPad_FEAT.ui'
#
...
"}")
        ...
        self.pbSpace = QtWidgets.QPushButton(numpad)
        self.pbSpace.setMinimumSize(QtCore.QSize(397, 49))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(16)
        self.pbSpace.setFont(font)
        self.pbSpace.setObjectName("pbSpace")
        self.verticalLayout.addWidget(self.pbSpace)
    ...
    def retranslateUi(self, numpad):
        ...
        self.pbSpace.setText(_translate("numpad", "SPACE"))
